...
package com.nbilyk.utils {
	...
	public final class MathUtils {
		...
		/**
		 * Clamps a number to always be between two values.
		 * e.g. 
		 * MathUtils.clamp(1.1, 0, 1) // returns 1.0
		 * MathUtils.clamp(-.1, 0, 1) // returns 1.0
		 * MathUtils.clamp(0.5, 0, 1) // returns 0.5
		 */
		...
		/**
		 * Snaps a value to the given snapInterval. 
		 * e.g.
		 * MathUtils.snap(1.12, 0.1) // returns 1.1
		 * MathUtils.snap(5.5, 1) // returns 6.0
		 * MathUtils.snap(1.3, 1, 0.2) // returns 1.2
		 */
		public static function snap(value:Number, snapInterval:Number, offset:Number = 0):Number {
			value -= offset;
			value /= snapInterval;
